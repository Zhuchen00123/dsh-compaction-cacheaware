 ...
 */
export const REASONIX_UPSTREAM_COMMIT = "352d171b3254c36cb36dd25532d0ef7e6f7d7f0a";
export const REASONIX_DEFAULT_COMPACT_RATIO = 0.85;
export const REASONIX_CHECKPOINT_CEILING_RATIO = 0.5;
export const REASONIX_RECENT_TAIL_BUDGET_RATIO = 0.1;
export const REASONIX_MIN_RECENT_TAIL_TOKENS = 32768;
export const REASONIX_MAX_RECENT_TAIL_TOKENS = 98304;
export const REASONIX_SUMMARY_OUTPUT_MAX_TOKENS = 16384;
export const REASONIX_EXCEPTIONAL_MIN_SAVINGS_RATIO = 0.25;
export const REASONIX_MIN_RECENT_KEEP = 2;
export const REASONIX_MIN_COMPACT_MESSAGES = 2;
export const REASONIX_MAX_PINNED_FIRST_USER_TOKENS = 1500;
export const REASONIX_PINNED_FIRST_USER_WINDOW_FRAC = 0.15;
export const REASONIX_MAX_KEPT_USER_TURN_TOKENS = 1500;
export const REASONIX_KEPT_USER_TURNS_BUDGET_TOKENS = 8192;
export const REASONIX_KEPT_USER_TURNS_WINDOW_FRAC = 0.05;
